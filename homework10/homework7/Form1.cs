...
namespace homework7
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            bindingSource1.DataSource = os.GetAllOrders();
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            catch (Exception x)
            {
                ...
                if (MessageBox.Show(null, x.Message, "出错了", MessageBoxButtons.RetryCancel) == DialogResult.Cancel)
                {
                    return;
                }
                else
        ...
        private void button7_Click(object sender, System.EventArgs e)
        {
            ...
            List<Order> order = os.GetOrderByCustomer(s);
            bindingSource1.DataSource = order;
        }
        /// <summary>
        /// 按商品名查询
        ...
        private void button8_Click(object sender, System.EventArgs e)
        {
            ...
            List<Order> order = os.GetOrderByName(s);
            bindingSource1.DataSource = order;
        }
